...
export default function Shop() {
  return (
    <div className="max-w-7xl mx-auto py-20">
      <h3 className="text-eerie-black text-4xl font-family-justice mb-6">Collections</h3>
      <div className="grid grid-cols-4 gap-10">
        <div className="flex flex-col items-center">
          ...
          <h6 className="font-family-justice text-2xl mt-4 mb-2">COFFEE</h6>
        ...
        <div className="flex flex-col items-center">
          ...
          <h6 className="font-family-justice text-2xl mt-4 mb-2">APPAREL</h6>
          <button className="text-sm text-primary-light hover:opacity-80">More info →</button>
        </div>
        <div className="flex flex-col items-center">
          <div className="h-96 rounded overflow-hidden shadow-lg cursor-pointer hover:opacity-80">
          ...
          <h6 className="font-family-justice text-2xl mt-4 mb-2">GIFTS & ACCESSORIES</h6>
          <button className="text-sm text-primary-light hover:opacity-80">More info →</button>
        </div>
        <div className="flex flex-col items-center">
          <div className="h-96 rounded overflow-hidden shadow-lg cursor-pointer hover:opacity-80">
          ...
          <h6 className="font-family-justice text-2xl mt-4 mb-2">SYRUPS</h6>
          <button className="text-sm text-primary-light hover:opacity-80">More info →</button>
        </div>
      </div>
    </div>
